...
export const Highlights = () => {
    ...
    return (
        <div className="main__highlights highlights-main main__item">
            ...
            >
                <SwiperSlide >
                    <NavLink to={''} onClick={handleInDevelop} data-popup="#popup-timeline-post" className="highlights-main__item item-highlights-main item-highlights-main--new swiper-slide">
                ...
                <SwiperSlide >
                    <NavLink to={'/profile'} className="highlights-main__item item-highlights-main swiper-slide">
                        <div className="item-highlights-main__image">
