                    ...
                    <div  className="popup-add-vid__body popup__body">
                        ...
                        <div  className="popup-add-vid__block">
                            <div  className="input-box">
                                <label>Title</label>
                                <input type="text" placeholder="Video title"  className="input-box__input input input-main"/>
                            </div>
                            <div  className="input-box">
                                <label>Description</label>
                                <input type="text" placeholder="Video description"  className="input-box__input input input-main"/>
                            </div>
                            <div  className="input-box">
                                <label>Add tag</label>
                                <div  className="input-box__select select-custom input input-main">
                                    <div  className="select-custom__body ">
                                        <p></p>
                                    </div>
                                    <button  className="select-custom__button button"><span>Add tag</span></button>
                                    <ul  className="select-custom__list">
                                        <li  className="select-custom__item">New</li>
                                        <li  className="select-custom__item">Download</li>
                                        <li  className="select-custom__item">Lorem, ipsum.</li>
                                    </ul>
                                </div>
                            </div>
                            <div  className="input-box-block">
                                <div  className="input-box">
                                    ...
                                    <div  className="input-block input input-main">
                                        <input type="number" placeholder="Price"  className="input-box__input"/>
                                ...
                                <div  className="input-box">
                                    <label>Sale</label>
                                    <div  className="input-block input input-main">
                                        <input type="number" placeholder="Sale"  className="input-box__input"/>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div  className="files-add-vid__items">
                                    <div  className="files-add-vid__item item-files-add-vid">
                                        <div  className="item-files-add-vid__body">
                                            <picture><source srcSet="img/post/01.webp" type="image/webp"/><img src="img/post/01.jpg" alt="ph"/></picture>
                                        </div>
                                        <div  className="item-files-add-vid__delete">
                                            <button  className="item-files-add-vid__delete-btn">
                        ...
                        <div  className="popup-add-vid__actions actions-popup-add-vid">
                            <div  className="actions-popup-add-vid__block">
                                <div  className="actions-popup-add-vid__item">
                                    ...
                                    <div  className="switch">
                                        <div  className="switch__body">
                                            <input type="checkbox" id="switch-download"  className="switch__input"/>
                                ...
                                <div  className="actions-popup-add-vid__item">
                                    ...
                                    <div  className="switch">
                                        <div  className="switch__body">
                                            <input type="checkbox" id="switch-comments"  className="switch__input"/>
