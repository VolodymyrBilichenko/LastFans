    ...
    return (
        <header className="header">
            <div className="header__wrapper">
                <div className="header__menu-button button-menu-header">
                                        ...
                                        <div className="popup-notifications-header__body body-popup-notifications-header">
                                            <div className="body-popup-notifications-header__item item-notifications item-notifications--unread item-notifications--love">
                                                ...
                                                <div className="item-notifications__body body-item-notifications">
                                                    <div className="body-item-notifications__top">
                                                        <a href="some" className="body-item-notifications__name">darkangeel</a>
                                                        <p className="body-item-notifications__username">@darkangeel</p>
                                                    </div>
                                                    <div className="body-item-notifications__content content-body-item-notifications">
                                                        <p className="content-body-item-notifications__text">reacted with</p>
                                                        <span>
                                                            <div className="content-body-item-notifications__icon love">
                                                                <img src="img/icons/love.svg" alt="Icon"/>
                                                            </div>
                                                            Love
                                                        </span>
                                                        <p className="content-body-item-notifications__text">on your post</p>
                                                    </div>
                                            ...
                                            <div className="body-popup-notifications-header__item item-notifications item-notifications--unread item-notifications--tip">
                                                ...
                                                <div className="item-notifications__body body-item-notifications">
                                                    ...
                                                    <div className="body-item-notifications__content content-body-item-notifications">
                                                        <p className="content-body-item-notifications__text">has sent you an tip in value of <span>$0.80</span></p>
                                                    </div>
                                                    <span className="body-item-notifications__time">
                                                        <div className="body-item-notifications__time-icon time">
                                                            <img src="img/icons/clock.svg" alt="Icon"/>
