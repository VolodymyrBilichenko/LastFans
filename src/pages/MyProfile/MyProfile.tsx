...
//         checkFormValidity(e.target.value, usertagValue);
//     };

//     const handleUsertagChange = (e: React.ChangeEvent<HTMLInputElement>) => {
//         setUsertagValue(e.target.value);
//         checkFormValidity(usernameValue, e.target.value);
//     };

//     const checkFormValidity = (username: string, usertag: string) => {
//         if (username.trim() && usertag.trim()) {
//             setIsFormValid(true);
//         } else {
...
//         } else {
//             toast.error('Your data has been failed');
//         }
//     };

//     useEffect(() => {
//         checkFormValidity(usernameValue, usertagValue);
//     }, [usernameValue, usertagValue]);
...
//                                 <input type="text" value={usernameValue} onChange={handleUsernameChange} placeholder="Display name" className="content-body-profile__input input input-main"/>
//                                 <input type="text" value={usertagValue} onChange={handleUsertagChange} placeholder="Username" className="content-body-profile__input input input-main"/>
...
//                                 </div>
//                             </div>}
//                             <button onClick={handleSaveChanges} className="body-profile__button button"><span>Save changes</span></button>
//                         </div>
...
export const MyProfile = () => {
    ...
    const [usertagValue, setUsertagValue] = useState<string>(user.usertag);
    const [usertagError, setUsertagError] = useState<string>("");
