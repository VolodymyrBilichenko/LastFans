                ...
                <div className="page-subscribers__container">
                    <div className="page-subscribers__body">
                        <div className="page-subscribers__tabs tabs-subscribers">
                            ...
                            <div className="tabs-content-profile__item groups-tab active">
                            ...
                            <div className="groups">
                                <div className="groups__items">
                                    <div className="groups__item item-groups">
                                        <a href="some" className="item-groups__link">
                                        ...
                                        <div className="item-groups__actions">
                                            <a href="some" className="item-groups__message">
                                                <img src={GroupMessIc} alt="Icon"/>
                                            </a>
                                            <button className="item-groups__delete">
