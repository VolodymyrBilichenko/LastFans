                ...
                <div  className="input-box">
                    ...
                    <div  className="add-tag select-custom input input-main">
                        <div  className="add-tag__content">
                            {/* {tags.map()} */}
                            <div className="add-tag__item item-tag">
                                <p className="item-tag__text">tag-01</p>
                                <button className='item-tag__delete'>
                        ...
                        <div className="add-tag__block">
                            <input type="text" placeholder='Add tag' className='input' value={newTagValue} onChange={(e) => setNewTagValue(e.target.value)}/>
                            <button  className="add-tag__button button" onClick={handleAddNewTag}><span>Add tag</span></button>
                        </div>
