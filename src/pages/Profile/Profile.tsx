...
export const Profile = () => {
    return (
        <main className="page page-profile-model">
            <AsideMenu/>
                            ...
                            <div className="body-profile__wrapper">
                                <div className="body-profile__top top-body-profile">
                                    ...
                                    <div className="top-body-profile__actions">
                                        <a href="some" className="top-body-profile__button top-body-profile__button--message button">
                                        ...
                                        <a href="some" className="top-body-profile__button top-body-profile__button--gift button button--transparent">
                    ...
                    <div className="profile__block">
                        <div className="profile__promotional promotional-profile">
                            ...
                            <a href="some" data-popup="#popup-successfull" className="promotional-profile__button button-subscribe button">
                                <div className="button-subscribe__block"><p>Subscribe (<span>60%</span>off)</p></div>
                                <div className="button-subscribe__price">
                                    <p><span className="button-subscribe__value">$10</span><span className="button-subscribe__discount">$25.00</span>(per month)</p>
                                </div>
                            </a>
                        </div>
                        <div className="profile__folders folders-profile">
                            <div className="folders-profile__item active"><p>Тело</p></div>
                            <div className="folders-profile__item"><p>Попа</p></div>
                            <div className="folders-profile__item"><p>Сиськи</p></div>
                            <div className="folders-profile__item"><p>Тело</p></div>
                            <div className="folders-profile__item"><p>Попа</p></div>
                            <div className="folders-profile__item"><p>Сиськи</p></div>
                        </div>
                    </div>
                    <div className="profile__content content-profile">
                        <div className="content-profile__tabs tabs-content-profile">
                            <div className="tabs-content-profile__item">
                                <p className="tabs-content-profile__name"><span>2379</span> Posts</p>
                            </div>
                            <div className="tabs-content-profile__item">
                                <p className="tabs-content-profile__name"><span>6419</span> MEDIA</p>
                            </div>
                                            ...
                                            <div className="content-post__image gallery__image">
                                                ...
                                                <div className="content-post__image-unlock unlock">
                                                    <div className="unlock__body">
                                                        ...
                                                        <a href="some" className="unlock__button button button--fw"><span>Unlock for $ <span className="unlock__button-price">12</span></span></a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="content-post__image gallery__image">
                                                ...
                                                <div className="content-post__image-unlock unlock">
                                                    <div className="unlock__body">
                                                        ...
                                                        <a href="some" className="unlock__button button button--fw"><span>Subscribe</span></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="content-post__image gallery__image">
