                ...
                <div className="main-messages__body">
                    <div className="main-messages__wrapper">
                        ...
                        <div className="groups__slider ">
                            ...
                            <div onClick={() => handleGroupClick('group1')} className={`groups__item item-groups groups__slide ${activeChat === 'group1' ? 'active' : ''}`}>
                                <div className="item-groups__body">
                            ...
                            <div onClick={() => handleGroupClick('group2')} className={`groups__item item-groups groups__slide ${activeChat === 'group2' ? 'active' : ''}`}>
                                <div className="item-groups__body">
                            ...
                            <div onClick={() => handleGroupClick('group3')} className={`groups__item item-groups groups__slide ${activeChat === 'group3' ? 'active' : ''}`}>
                                <div className="item-groups__body">
                                    <p className="item-groups__name">50/50</p>
                                    <div className="item-groups__people">
                                        <div className="item-groups__people-icon">
                                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g clip-path="url(#clip0_239_14180)">
                    ...
                    <div className="messages-user__block">
                        ...
                        <div className="messages-user__themes themes-messages-user">
                            ...
                            <div className="themes-messages-user__items">
                                <div onClick={_ => handleChooseTheme('')} style={{background: 'linear-gradient(90deg, #ff9a9e 0%, #fad0c4 99%, #fad0c4 100%)'}} className="themes-messages-user__item"></div>
                                <div onClick={_ => handleChooseTheme('purple')} style={{background: 'linear-gradient(90deg, #a18cd1 0%, #fbc2eb 100%)'}} className="themes-messages-user__item"></div>
                                <div onClick={_ => handleChooseTheme('')} style={{background: 'linear-gradient(90deg, #fad0c4 0%, #fad0c4 1%, #ffd1ff 100%)'}} className="themes-messages-user__item"></div>
                                <div onClick={_ => handleChooseTheme('')} style={{background: 'linear-gradient(90deg, #ffecd2 0%, #fcb69f 100%)'}} className="themes-messages-user__item"></div>
                                <div onClick={_ => handleChooseTheme('')} style={{background: 'linear-gradient(90deg, #ffecd2 0%, #fcb69f 100%)'}} className="themes-messages-user__item"></div>
                                <div onClick={_ => handleChooseTheme('red')} style={{background: 'linear-gradient(90deg, #ff8177 0%, #ff867a 0%, #ff8c7f 21%, #f99185 52%, #cf556c 78%, #b12a5b 100%)'}} className="themes-messages-user__item"></div>
                                <div onClick={_ => handleChooseTheme('')} style={{background: 'linear-gradient(90deg, #ff9a9e 0%, #fecfef 99%, #fecfef 100%)'}} className="themes-messages-user__item"></div>
                                <div onClick={_ => handleChooseTheme('')} style={{background: 'linear-gradient(90deg, #fbc2eb 0%, #a6c1ee 100%)'}} className="themes-messages-user__item"></div>
                                <div onClick={_ => handleChooseTheme('blue')} style={{background: 'linear-gradient(90deg, #a1c4fd 0%, #c2e9fb 100%)'}} className="themes-messages-user__item"></div>
                                <div onClick={_ => handleChooseTheme('green')} style={{background: 'linear-gradient(90deg, #d4fc79 0%, #96e6a1 100%)'}} className="themes-messages-user__item"></div>
