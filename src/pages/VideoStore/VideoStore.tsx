    ...
    return (
        <main className="page page-main">
            ...
            <div className="video-store">
                <div className="video-store__filters filters-video-store">
                    <div className="filters-video-store__top top-filters-video-store">
                        <ul className="top-filters-video-store__items">
                            <li>
                                <a href="some" className="top-filters-video-store__item">
                        ...
                        <button className="filters-video-store__close">
                                ...
                                <div className="block-filters-video-store__item item-filter">
                                    <div className="form-block">
                                        <label>
                                            <input type="checkbox" name="conditions" className="real-checkbox"/>
                                            <span className="custom-checkbox"></span>
                                            <p className="form-block__text">$25 to $50</p>
                                        </label>
                                    </div>
                                </div>
                                <div className="block-filters-video-store__item item-filter">
                                    <div className="form-block">
                                        <label>
                                            <input type="checkbox" name="conditions" className="real-checkbox"/>
                                            <span className="custom-checkbox"></span>
                                            <p className="form-block__text">Under $10</p>
                                        </label>
                                    </div>
                                </div>
                                <div className="block-filters-video-store__item item-filter">
                                    <div className="form-block">
                                        <label>
                                            <input type="checkbox" name="conditions" className="real-checkbox"/>
                                            <span className="custom-checkbox"></span>
                                            <p className="form-block__text">$50 to $100</p>
                                        </label>
                                    </div>
                                </div>
                                <div className="block-filters-video-store__item item-filter">
                                    <div className="form-block">
                                        <label>
                                            <input type="checkbox" name="conditions" className="real-checkbox"/>
                                            <span className="custom-checkbox"></span>
                                            <p className="form-block__text">$10 to $25</p>
                                        </label>
                                    </div>
                                </div>
                                <div className="block-filters-video-store__item item-filter">
                                    <div className="form-block">
                                        <label>
                                            <input type="checkbox" name="conditions" className="real-checkbox"/>
                                            <span className="custom-checkbox"></span>
                                            <p className="form-block__text">$100+</p>
                                        </label>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="video-store__container">
                    <div className="video-store__header header-video-store">
                        ...
                        <div className="header-video-store__block">
                            <button className="header-video-store__filter button button--transparent">
                                <span>Filters</span>
                            ...
                            <div className="content-video-store__item item-video-store">
                                <div className="item-video-store__wrapper">
                                    <div className="item-video-store__image">
                                        ...
                                        <div className="item-video-store__price"><p>$<span>11.99</span></p></div>
                                    </div>
                                ...
                                <div className="item-video-store__tags">
                                    <div className="item-video-store__tag tag-item-video-store tag-item-video-store--purple">
                                    ...
                                    <div className="item-video-store__tag tag-item-video-store tag-item-video-store--green">
                                        <div className="tag-item-video-store__body">
