                ...
                <div className="page-subscribers__body">
                    ...
                    <div className="page-subscribers__content">
                        ...
                        <div className="page-subscribers__items">
                            ...
                            <div className="page-subscribers__item item-video-store">
                                <div className="item-video-store__wrapper">
                                    <a href="some" className="item-video-store__link">
                                    ...
                                    <div className="item-video-store__body">
                                        ...
                                        <div className="item-video-store__content">
                                            <div className="item-video-store__top">
                                                ...
                                                <p className="item-video-store__value">$ <span>854.76</span></p>
                                            </div>
                                            <div className="item-video-store__block">
                                                ...
                                                <div className="item-video-store__actions">
                                                    <button className="item-video-store__add">
                                                    ...
                                                    <a href="some" className="item-video-store__message">
                                ...
                                <div className="item-video-store__tags">
                                    <div className="item-video-store__tag tag-item-video-store tag-item-video-store--blue">
                                        <div className="tag-item-video-store__body">
                                            <p className="tag-item-video-store__text">Subscriber</p>
                                        </div>
                        ...
                        <div className="page-subscribers__items followers">
                            <div className="page-subscribers__item item-video-store">
                                ...
                                <div className="item-video-store__tags">
                                    <div className="item-video-store__tag tag-item-video-store tag-item-video-store--yellow">
                                        <div className="tag-item-video-store__body">
                                            <p className="tag-item-video-store__text">Subscriber</p>
                                        </div>
                                        <div className="tag-item-video-store__decor"></div>
