								...
								<div className="item-page-menu__image">
									<div className="item-page-menu__image-body">
										<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M16.3333 3.57814C15.6144 3.52456 14.8379 3.5 14 3.5C5.83333 3.5 3.5 5.83333 3.5 14C3.5 22.1667 5.83333 24.5 14 24.5C22.1667 24.5 24.5 22.1667 24.5 14.6176C24.5 13.5393 24.4648 12.5582 24.388 11.6667" stroke="#B5CBED" style={{stroke:'#B5CBED',  strokeOpacity:1}} stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" />
											<path d="M22.1654 8.16667C23.454 8.16667 24.4987 7.122 24.4987 5.83333C24.4987 4.54467 23.454 3.5 22.1654 3.5C20.8767 3.5 19.832 4.54467 19.832 5.83333C19.832 7.122 20.8767 8.16667 22.1654 8.16667Z" stroke="#B5CBED" style={{stroke:'#B5CBED',  strokeOpacity:1}} stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" />
											<path d="M8.16797 17.5C10.268 14.5 11.0089 12.8272 12.4634 13.2222C13.5373 13.5139 13.6285 14.9179 14.8498 15.1667C16.4862 15.5 17.093 13 18.668 10.5" stroke="#B5CBED" style={{stroke:'#B5CBED',  strokeOpacity:1}} stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" />
										</svg>
						...
						<div className="page-menu__items">
							...
							<a href="some" className="page-menu__item item-page-menu">
								<div className="item-page-menu__image">
									<div className="item-page-menu__image-body">
										<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M5.83333 3.5H17.5C18.1188 3.5 18.7123 3.74583 19.1499 4.18342C19.5875 4.621 19.8333 5.21449 19.8333 5.83333V24.5H5.83333C5.21449 24.5 4.621 24.2542 4.18342 23.8166C3.74583 23.379 3.5 22.7855 3.5 22.1667V5.83333C3.5 5.21449 3.74583 4.621 4.18342 4.18342C4.621 3.74583 5.21449 3.5 5.83333 3.5V3.5Z" stroke="#B5CBED" style={{stroke:'#B5CBED',  strokeOpacity:'1'}} stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" />
											<path d="M19.834 14H24.5007V22.1667C24.5007 22.7855 24.2548 23.379 23.8172 23.8166C23.3796 24.2542 22.7862 24.5 22.1673 24.5H19.834V14Z" stroke="#B5CBED" style={{stroke:'#B5CBED',  strokeOpacity:'1'}} stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" />
											<path d="M8.16602 9.33331H15.166" stroke="#B5CBED" style={{stroke:'#B5CBED',  strokeOpacity:'1'}} stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" />
											<path d="M8.16602 14H15.166" stroke="#B5CBED" style={{stroke:'#B5CBED',  strokeOpacity:'1'}} stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" />
											<path d="M8.16602 18.6667H11.666" stroke="#B5CBED" style={{stroke:'#B5CBED',  strokeOpacity:'1'}} stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" />
										</svg>
